              ...
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Total Campaigns Created</p>
                      <p class="card-title"><?php $sql1="SELECT COUNT(campaign_id) AS noOfCamp FROM campaigns WHERE campaignCreator='$user';"; 
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Total Approved Campaigns</p>
                      <p class="card-title"><?php $sql1="SELECT COUNT(campaign_id) AS noOfCamp FROM campaigns WHERE campaignCreator='$user' and campaignApproval=1;"; 
				    $result1=mysqli_query($conn,$sql1);
				    $row= mysqli_fetch_assoc($result1);
				    echo $row['noOfCamp']; ?><p>
                    </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Your Campaigns yet to be Approved</h4>
                <p>you can edit your unapproved campaigns</p>
              </div>
              <div class="card-body">
