...
if(isset($_POST['add_campaign_submit']))
{
    ...
    $campaigncreator = $_SESSION['o_username'];
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control textarea" name="campaignDescription">Write something about your campaign here!</textarea>
                      </div>
                    </div>
                  </div>
                ...
                <input type="hidden" name="approval" value="1">
                  <div class="row">
                    <div class="update ml-auto mr-auto">
                      <button type="submit" name="add_campaign_submit" class="btn btn-primary btn-round">Add Campaign for verification</button>
                    </div>
                  </div>
                </form>
              </div>
